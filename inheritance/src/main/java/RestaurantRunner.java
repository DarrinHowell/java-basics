...
//
//        for(String movie : newCineplex.getMoviesList()){
//            System.out.println(movie);
//            System.out.println();
//        }
//
//
//        newCineplex.removeMovie("Batman: Arctic Storm");
//
//        for(String movie : newCineplex.getMoviesList()){
//            System.out.println("after removal: " + movie);
//            System.out.println();
//        }
...
//        Review testReview = new Review("So, so good.", "D$", 8);
//
//        newCineplex.addReview(testReview);
//
//        System.out.println("this is the avg movie Review" + newCineplex.getAvgStars());
